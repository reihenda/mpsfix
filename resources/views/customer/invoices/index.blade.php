...
<div class="card">
    <div class="card-header">
        <div class="d-flex justify-content-between align-items-center">
            <h3 class="card-title">Daftar Invoice Saya</h3>
            <span class="badge badge-info">Total: {{ $invoices->total() }} invoice</span>
        </div>
        <div class="mt-3">
            <div class="row">
                <div class="col-md-6">
    ...
    <div class="card-body">
        ...
        <div id="invoice-table-container">
            @include('customer.invoices.partials.invoice-table')
        </div>
    </div>
    <div class="card-footer clearfix" id="pagination-container">
        @include('customer.invoices.partials.pagination')
    </div>
</div>
@endsection
...
<script>
    $(document).ready(function() {
        ...
        function performSearch() {
            const searchTerm = $('#searchInvoice').val();
        ...
        // Event listener untuk filter status dan periode
