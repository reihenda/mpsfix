...
<div class="card">
    ...
    <form action="{{ route('keuangan.kas.store') }}" method="POST">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('voucher_number') is-invalid @enderror" 
                    id="voucher_number" name="voucher_number" value="{{ old('voucher_number', $voucherNumber) }}" readonly>
                @error('voucher_number')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
                <small class="form-text text-muted">Nomor voucher dihasilkan secara otomatis.</small>
            </div>
            
            <div class="form-group">
                <label for="transaction_date">Tanggal Transaksi <span class="text-danger">*</span></label>
                <input type="date" class="form-control @error('transaction_date') is-invalid @enderror" 
                    id="transaction_date" name="transaction_date" value="{{ old('transaction_date', date('Y-m-d')) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control mt-2 @error('description') is-invalid @enderror" 
                    id="description" name="description" rows="2" placeholder="Masukkan deskripsi transaksi atau pilih dari dropdown di atas">{{ old('description') }}</textarea>
                @error('description')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control money @error('credit') is-invalid @enderror" 
                                id="credit" name="credit" value="{{ old('credit', '0') }}" 
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control money @error('debit') is-invalid @enderror" 
                                id="debit" name="debit" value="{{ old('debit', '0') }}" 
                                data-thousands="." data-decimal="," placeholder="0">
                        </div>
                        @error('debit')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
        ...
        <div class="card-footer">
            ...
            <a href="{{ route('keuangan.kas.index') }}" class="btn btn-secondary">
...
<script>
    $(document).ready(function() {
        ...
        // Load deskripsi transaksi berdasarkan kategori (kas)
        loadDescriptions('kas');
