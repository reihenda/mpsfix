...
class DataPencatatanController extends Controller
{
    ...
    /**
     * Print Deposit History for Customer
     * 
    ...
    public function printDepositHistory(Request $request, User $customer)
    {
        ...
        // Calculate balance
        $saldoTersisa = $customer->total_deposit - $customer->total_purchases;
        ...
        $data = [
            ...
            'totalDepositOverall' => $customer->total_deposit,
            'totalPurchaseOverall' => $customer->total_purchases,
